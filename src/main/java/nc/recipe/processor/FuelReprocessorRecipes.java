...
public class FuelReprocessorRecipes extends ProcessorRecipeHandler {
	...
	public void addRecipes() {
		...
		/* 1/32x */	addReprocessingRecipes("HECf251", "Californium251", 16, "Californium252", 16, "Einsteinium253", 20, "Einsteinium254", 12);
				...
				addReprocessingRecipes("LEFm255", "Fermium254", 4, "Fermium255", 28, "Fermium257", 16, "Fermium257", 16);
				addReprocessingRecipes("HEFm255", "Fermium254", 8, "Fermium255", 16, "Fermium257", 20, "Fermium257", 20);
